...
describe('PricedButton', () => {
  ...
  describe('Sufficient funds', () => {
    ...
    it('renders a span saying "Fee: 5 SHIFT"', () => {
      expect(wrapper.find(`.${styles.fee}`).text()).to.be.equal(i18n.t('Fee: {{fee}} SHIFT', { fee: 5 }));
    });
  ...
  describe('Insufficient funds', () => {
    ...
    it('renders a span saying "Insufficient funds for 5 SHIFT fee"', () => {
      expect(wrapper.find(`.${styles.fee}`).text()).to.be.equal('Insufficient funds for 5 SHIFT fee');
    });

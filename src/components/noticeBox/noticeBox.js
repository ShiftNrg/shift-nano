...
const NoticeBox = ({ t, account }) => (
  !account.serverPublicKey && (account.balance * 1) > 0 ?
    <div className={`box ${styles.wrapper}`}>
      ...
      <p>
        {t('The easiest and cheapest way to do this is to send SHIFT to yourself by clicking this button. It will cost you only the usual 0.01 SHIFT transaction fee.')}
      </p>
